...
namespace Simple.Rebus.Configuration
{
    /// <summary>
    /// Configures rebus to use the filesystem store for everything.
    /// <see cref="Rebus.Recipes/Rebus.Recipes/Configuration/FilesystemRebusConfigurationExtensions.cs "/>
    /// <seealso cref="https://github.com/rebus-org/Rebus.Recipes.git"/>
    /// </summary>
